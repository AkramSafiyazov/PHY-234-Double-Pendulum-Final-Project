...
t_start = 0
t_end = 3000 # Integration time
t_span = [t_start, t_end] 
t_arr = np.linspace(t_start, t_end, 10000)

# Defining the range of ICs for varying phi2 from 0 to pi with 180 points inbetween them.

q_init_array = np.array([[0, 0, i, 0] for i in np.linspace(-1e-6, np.pi-1e-6, 180)])
...
if __name__ == "__main__":
    ...
    filename = "poincare_general_varying_phi2"
